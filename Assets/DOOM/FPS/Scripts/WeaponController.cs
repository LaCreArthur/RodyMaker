...
public class WeaponController : MonoBehaviour
{
    ...
    public bool reloadsOverTime;
    [ShowIf("reloadsOverTime")]
    ...
    [Tooltip("Starting amount of ammo in the gun")]
    public float startAmmo = 8;
    ...
    public TMP_Text CurrentAmmoText { get;  set; }
    public bool isWeaponActive { get; private set; }
    public bool isWeaponUnlocked { get; set; }
    ...
    {
        get => m_CurrentAmmo;
        set { m_CurrentAmmo = value; if (CurrentAmmoText != null) CurrentAmmoText.text = Mathf.RoundToInt(value).ToString();}
    }
    ...
    void UpdateAmmo()
    {
        if (reloadsOverTime && m_LastTimeShot + ammoReloadDelay < Time.time && CurrentAmmo < maxAmmo && !isCharging)
        {
    ...
    public void PickupAmmo(float amount)
    {
        var pickableAmount = maxAmmo - CurrentAmmo;
        CurrentAmmo += pickableAmount < amount ? pickableAmount : amount;
    }
