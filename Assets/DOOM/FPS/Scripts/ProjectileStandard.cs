...
public class ProjectileStandard : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        // Hit detection
        {
            ...
            var size = Physics.SphereCastNonAlloc(m_LastRootPosition, radius, displacementSinceLastFrame.normalized, _hits, displacementSinceLastFrame.magnitude, hittableLayers, k_TriggerInteraction);
